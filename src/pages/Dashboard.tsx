...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead 
        title="Dashboard - Biomimetic Dentistry Club"
        description="Your personal dashboard for accessing courses, resources, and managing your dental education journey."
        keywords="dental dashboard, user profile, course progress, biomimetic dentistry"
      />
      <Navigation />

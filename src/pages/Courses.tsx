          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <p className="text-muted-foreground">
                Learn from world-renowned biomimetic dentistry specialists with decades of experience.
              </p>
            </motion.div>
            ...
            >
              ...
              <p className="text-muted-foreground">
                Self-paced courses that fit your schedule, with lifetime access to materials.
              </p>
            </motion.div>
            ...
            >
              ...
              <h3 className="text-xl font-bold text-foreground mb-2">Practical Focus</h3>
              <p className="text-muted-foreground">
                Hands-on techniques you can immediately apply in your practice for better outcomes.
              </p>
            </motion.div>
          </div>
        </div>

...
const Subscription = () => {
  ...
  return (
    <div className="min-h-screen bg-background">
      <SEOHead 
        title="Subscription Plans - Biomimetic Dentistry Club"
        description="Choose the perfect plan to advance your dental career with our exclusive content and community."
        keywords="dental subscription, dental courses, biomimetic training, dental education plans"
      />
      <Navigation />
